...
slug: virtualization
name: Virtualization
description: 'An index and topic collection covering virtualization across two intertwined domains: machine virtualization (hypervisors, virtual machines, VDI, and cloud VM platforms) and…'
...
overview: 'Virtualization is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [virtualization.apievangelist.com](https://virtualization.apievangelist.com).
  ...
  30 providers on the network work in this area, including Nutanix, Citrix, VMware, Vagrant, Solaris Zones, Google Cloud VMware Engine, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.
