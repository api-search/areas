...
overview: 'AI Automation is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [ai-automation.apievangelist.com](https://ai-automation.apievangelist.com).
  ...
  30 providers on the network work in this area, including Xquik, Brevo, Salesforce Marketing Cloud, Kit, MailerLite, Klaviyo, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Workflow Automation, Agents, Design, and Observability. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
