...
slug: bots
name: Bots
description: An index and topic collection covering chatbots, conversational agents, and bot frameworks across messaging, voice, and customer experience channels. Bots are scripted or…
...
overview: 'Bots is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [bots.apievangelist.com](https://bots.apievangelist.com).
  ...
  18 providers on the network work in this area, including Slack, Lichess, ZenZap, Zoho Cliq, Telegram, Microsoft Bot Framework, and 12 more — each links out to that provider''s APIs, schemas, and governance artifacts.
