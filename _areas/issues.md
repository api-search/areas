...
slug: issues
name: Issues
description: An index and topic collection covering issue tracking, bug tracking, and project-management APIs that expose issue, ticket, task, and work-item primitives. Issue tracking APIs are…
area_url: https://issues.apievangelist.com
area_host: issues.apievangelist.com
icon: https://issues.apievangelist.com/icon-thumb.png
provider_count: 2
providers:
- slug: plane
  name: Plane
...
overview: 'Issues is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [issues.apievangelist.com](https://issues.apievangelist.com).
  ...
  Providers on the network working in this area include Plane and Forgejo — each links out to that provider''s APIs, schemas, and governance artifacts.'
---
