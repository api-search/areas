...
overview: 'Monitoring is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [monitoring.apievangelist.com](https://monitoring.apievangelist.com).
  ...
  30 providers on the network work in this area, including New Relic, Datadog, Splunk, Azure Log Analytics, Oracle Enterprise Manager, Raygun, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.
