...
overview: 'Observability is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [observability.apievangelist.com](https://observability.apievangelist.com).
  ...
  30 providers on the network work in this area, including New Relic, Dynatrace, Logz.io, Fastly, Sentry, Vercel, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Monitoring, Security, Containers, and Logging. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
