...
overview: 'Microservices is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [microservices.apievangelist.com](https://microservices.apievangelist.com).
  ...
  30 providers on the network work in this area, including Apigee, AWS App Mesh, NVIDIA NIM, IBM WebSphere, Azure Container Apps, Amazon Cloud Map, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Service Mesh, Containers, Integrations, and Observability. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
