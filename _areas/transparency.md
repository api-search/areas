...
slug: transparency
name: Transparency
description: An index and topic collection covering public-facing transparency surfaces across the API and platform ecosystem. Transparency in this context refers to the mechanisms platforms…
...
overview: 'Transparency is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [transparency.apievangelist.com](https://transparency.apievangelist.com).
  ...
  Providers on the network working in this area include Loon Finance, Free Law Project, Freedom of Information Act, CMS Open Payments, USAspending.gov, and ENTSO-E — each links out to that provider''s APIs, schemas, and governance artifacts.'
---
