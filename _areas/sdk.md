...
slug: sdk
name: SDKs
description: A curated index of services, tooling, and open source solutions for generating API SDKs, client libraries, and code from API specifications. This collection covers SDK generation…
...
- slug: sanas
  name: Sanas
  description: Sanas is a real-time speech AI platform that removes communication barriers through accent translation, language translation, speech enhancement, and speech intelligence. Its developer platform exposes these capabilities as a server-side SDK (C++17 and Python) plus a persistent WebSocket Stream API…
  api_count: 2
  score_band: developing
...
overview: 'SDKs is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [sdk.apievangelist.com](https://sdk.apievangelist.com).
  ...
  30 providers on the network work in this area, including Cvent Event Cloud, General Translation, Dwolla, Suki AI, Swagger Codegen, Lucra Sports, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Documentation, API Evangelist Search, Authentication, and Command Line Interface. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
