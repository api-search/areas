...
overview: 'SDKs is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [sdk.apievangelist.com](https://sdk.apievangelist.com).
  ...
  30 providers on the network work in this area, including Speakeasy, Android, General Translation, Dwolla, Chroma, Krisp, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.
