...
slug: embeddable
name: Embeddable
description: An index and topic collection covering embeddable widgets, JavaScript SDKs, iframe-able experiences, and embedded analytics. Embeddable platforms allow product teams to drop…
...
overview: 'Embeddable is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [embeddable.apievangelist.com](https://embeddable.apievangelist.com).
  ...
  Providers on the network working in this area include Cast Corporation, Screenleap, Confrere, and Desmos — each links out to that provider''s APIs, schemas, and governance artifacts.'
---
