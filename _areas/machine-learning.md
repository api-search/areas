...
overview: 'Machine Learning is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [machine-learning.apievangelist.com](https://machine-learning.apievangelist.com).
  ...
  30 providers on the network work in this area, including Anthropic, GitHub Copilot, Amazon Kendra, IBM, Amazon SageMaker, Amazon Entity Resolution, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Security, Agents, Containers, and Monitoring. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
