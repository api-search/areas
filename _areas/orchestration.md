...
slug: orchestration
name: Orchestration
description: An index and topic collection covering container orchestration and workflow orchestration platforms. Container orchestration platforms like Kubernetes, OpenShift, Amazon EKS,…
...
overview: 'Orchestration is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [orchestration.apievangelist.com](https://orchestration.apievangelist.com).
  ...
  30 providers on the network work in this area, including UiPath, Workato, Azure Kubernetes Service, Azure Kubernetes Service, Workday Extend, Amazon Step Functions, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: AI Automation, Containers, Workflow Automation, and Embedded iPaaS. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
