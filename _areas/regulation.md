...
overview: 'Regulation is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [regulation.apievangelist.com](https://regulation.apievangelist.com).
  ...
  17 providers on the network work in this area, including Consumer Data Right (Energy), Australian Energy Regulator, FiscalNote, i6eal Open AI Data API, KPMG, RICS (Royal Institution of Chartered Surveyors), and 11 more — each links out to that provider''s APIs, schemas, and governance artifacts.
