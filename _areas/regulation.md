...
slug: regulation
name: Regulation
description: Regulation encompasses the rules, laws, and standards established by governments, agencies, and standards bodies that govern how businesses and individuals must operate. In the…
...
- slug: national-indian-gaming-commission
  ...
  description: The National Indian Gaming Commission (NIGC) is an independent federal regulatory agency that regulates gaming on Indian lands to protect tribal gaming as a means of generating revenue for tribal governments. The agency publishes online resources, public records, and gaming-related data through its…
  api_count: 0
  score_band: minimal
  score_composite: 4.1
  shared: 1
...
overview: 'Regulation is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [regulation.apievangelist.com](https://regulation.apievangelist.com).
  ...
  16 providers on the network work in this area, including FiscalNote, Consumer Data Right (Energy), Australian Energy Regulator, KPMG, Australian Energy Market Commission, RICS (Royal Institution of Chartered Surveyors), and 10 more — each links out to that provider''s APIs, schemas, and governance artifacts.
