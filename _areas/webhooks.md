...
- slug: curlec
  name: Curlec
  description: Curlec (Razorpay Curlec) is a Malaysian online payment solution and part of Razorpay, the RBI-authorised full-stack payment platform. Curlec lets businesses in Malaysia accept one-time and recurring payments through a Payment Gateway, Payment Links, Payment Pages, Payment Buttons, hosted Checkout,…
  api_count: 30
  score_band: strong
...
overview: 'Webhooks is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [webhooks.apievangelist.com](https://webhooks.apievangelist.com).
  ...
  30 providers on the network work in this area, including Inngest, Fastly, Storyblok, Vercel, Buildkite, Square, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Observability, Integrations, SaaS Management, and Security. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
