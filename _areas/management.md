...
slug: management
name: Management
description: An index and topic collection covering full-stack API management platforms — solutions that combine an API gateway, developer portal, analytics, monetization, governance, and…
area_url: https://management.apievangelist.com
area_host: management.apievangelist.com
icon: https://management.apievangelist.com/icon-thumb.png
provider_count: 6
providers:
- slug: boomi
  name: Boomi
...
overview: 'Management is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [management.apievangelist.com](https://management.apievangelist.com).
  ...
  Providers on the network working in this area include Boomi, WunderGraph, Dell Servers, SnapLogic, Amazon Systems Manager, and Broadcom — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: SaaS Management, AI Automation, Embedded iPaaS, and Virtualization. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
