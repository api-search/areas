...
slug: agents-skills
name: Agent Skills
description: An index and topic collection covering Agent Skills, the packaged, file-based capability units that AI coding agents load to extend their behavior. Agent Skills bundle…
...
overview: 'Agent Skills is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [agents-skills.apievangelist.com](https://agents-skills.apievangelist.com).
  ...
  30 providers on the network work in this area, including SMTP2GO, KonbiniAPI, Anthropic, APIs.io, Unify, Parallel Web Systems, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Scraping, Agents, API Proxies, and Command Line Interface. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
