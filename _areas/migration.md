...
overview: 'Migration is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [migration.apievangelist.com](https://migration.apievangelist.com).
  ...
  15 providers on the network work in this area, including Amazon Mainframe Modernization, Amazon DataSync, Azure Migrate, Amazon DMS, KubeVirt, Google Cloud Migration Center, and 9 more — each links out to that provider''s APIs, schemas, and governance artifacts.
