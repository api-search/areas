...
slug: migration
name: Migration
description: An index and topic collection covering data migration, cloud migration, database migration, and API migration platforms and services. Migration platforms help organizations move…
...
overview: 'Migration is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [migration.apievangelist.com](https://migration.apievangelist.com).
  ...
  15 providers on the network work in this area, including Amazon Mainframe Modernization, Amazon DataSync, Azure Migrate, Amazon DMS, Google Cloud Migration Center, KubeVirt, and 9 more — each links out to that provider''s APIs, schemas, and governance artifacts.
