...
overview: 'Containers is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [containers.apievangelist.com](https://containers.apievangelist.com).
  ...
  30 providers on the network work in this area, including Azure Kubernetes Service, Cloudflare, Amazon ECR, Anchore, Amazon Managed Service for Prometheus, Aqua Security, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Orchestration, Deployment, Serverless, and Security. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
