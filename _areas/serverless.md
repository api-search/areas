...
overview: 'Serverless is one of the API Evangelist areas on the [APIs.io](https://apis.io/) network — a focused corner of the API landscape. The full area lives at [serverless.apievangelist.com](https://serverless.apievangelist.com).
  ...
  30 providers on the network work in this area, including Inngest, fal, IBM, Amazon DynamoDB, Amazon API Gateway, Amazon EventBridge Scheduler, and 24 more — each links out to that provider''s APIs, schemas, and governance artifacts.


  Related areas: Containers, Microservices, Orchestration, and Security. Browse every area at [areas.apis.io](https://apis.io/areas/).'
---
